...
This project models all of these relationships by forming a Bayesian Network of all the relevant variables, which considers a family of two parents and a single child.
